...
function getSpreadsheetId() {
  ...
  if (!id) {
    throw new Error(
      "REGULAR_2_SPREADSHEET_ID is missing."
    );
  }
            ...
            purchase_units: [
              {
                ...
                description:
                  "Akron Rescue Cats Regular Season Board 2 Football Squares: " +
  ...
  async fetch(request) {
    ...
    try {
      ...
      */
      ...
      console.error(
        "Regular Season Board 2 API error:",
        error
      );
