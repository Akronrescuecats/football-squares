...
function getSpreadsheetId() {
  ...
  if (!id) {
    throw new Error(
      "REGULAR_3_SPREADSHEET_ID is missing."
    );
  }
            ...
            purchase_units: [
              {
                ...
                description:
                  "Akron Rescue Cats Regular Season Board 3 Football Squares: " +
...
export default {
  ...
  async fetch(request) {
    ...
    try {
      ...
      console.error(
        "Regular Season Board 3 API error:",
        error
      );
